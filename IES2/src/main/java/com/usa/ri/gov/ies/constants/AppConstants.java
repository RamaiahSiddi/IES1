package com.usa.ri.gov.ies.constants;
...
public class AppConstants {
	...
	public static final String PLAN_REG_SUCCESS="planRegSuccess";
	public static final String PLAN_REG_FAILUER="planRegFailuer";
	...
	public static final String APP_PLANS="plans";
